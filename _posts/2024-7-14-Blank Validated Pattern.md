...
---
This [repository](https://github.com/jtovarro/hub-blank-vpattern) is in charge of applying day 2 configurations to the MANO cluster using Validated Pattern.
